...
| Then | Now |
|---|---|
| `svelte/src/routes/+page.svelte` (the status page) | [`cljs/src/hakkou/app.cljk`](cljs/src/hakkou/app.cljk) — same fields, faithfully ported |
...
Two fields in `cljs/src/hakkou/app.cljk`'s `default-db` were also corrected,
